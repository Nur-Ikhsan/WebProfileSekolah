        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a class="nav-link" href="/admin/sekolah/visi-misi">
    ...
    <main id="main" class="main">
                    ...
                    <script>
                      Swal.fire({
                        ...
                        if (result.isConfirmed) {
                          window.location.href = '/admin/sekolah/visi-misi';
                        }
                      });
                    </script>
                <?php else: ?>
        ...
        <div class="container">
            ...
            <div class="row align-items-center box-edit">
                <div class="col-12">
                    <form class="row justify-content-center" action="/admin/sekolah/visi-misi/edit" method="post">
                        <h4 class="text-center pb-3">Edit Data Visi & Misi</h4>
                        <div class="pos-zone row no-gutters">
                            <div class="col-2 p-0"><label for="deskripsi">Visi</label></div>
                            <div class="col-9 p-0"><textarea name="visi" id="misi" class="form-control textarea-tinymce"><?= $visiMisi->getVisi() ?></textarea></div>
                        </div>
                        <div class="pos-zone row no-gutters">
                            <div class="col-2 p-0"><label for="deskripsi">Misi</label></div>
                            <div class="col-9 p-0"><textarea name="misi" id="misi" class="form-control textarea-tinymce"><?= $visiMisi->getMisi() ?></textarea></div>
                        </div>
                        <div class="pos-zone row no-gutters">
