    ...
    <main id="main" class="main">
        <div class="container">
            ...
            <div class="row align-items-center box-edit">
                <div class="col-12">
                    <h4 class="text-center pb-3">Stuktur Organisasi</h4>
                    <div class="" id="pos-zone">
                        <div class="image-wrapper">
                            <img id="preview-image" class="d-block"
                                 src="/images/upload/struktur-organisasi/<?= $strukturOrganisasi->getStrukturOrganisasi() ?>"
                                 alt="Struktur Organisasi">
                        </div>
                    </div>
                    <div class="pos-zone row no-gutters m-0">
                        <div class="col-1"></div>
                        <div class="col-11 p-0 d-flex">
                            <a href="/admin/sekolah/struktur-organisasi/edit"
