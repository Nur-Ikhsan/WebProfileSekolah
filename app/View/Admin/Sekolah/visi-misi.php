    ...
    <main id="main" class="main">
        <div class="container">
            ...
            <div class="row align-items-center box-edit">
                <div class="col-12">
                    <h4 class="text-center pb-3">Visi & Misi</h4>
                    <div class="pos-zone row no-gutters">
                        <div class="col-3 p-0"><label for="nama_sekolah">Visi</label></div>
                        <div class="col-9 p-0">: <?= $visiMisi->getVisi() ?></div>
                    </div>
                    <div class="pos-zone row no-gutters">
                        <div class="col-3 p-0"><label for="alamat">Misi</label></div>
                        <div class="col-9 p-0">: <?= $visiMisi->getMisi() ?></div>
                    </div>
                    <div class="pos-zone row no-gutters">
                        <div class="col-3"></div>
                        <div class="col-9 p-0 d-flex">
                            <a href="/admin/sekolah/visi-misi/edit"
