        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a class="nav-link" href="/admin/sekolah/struktur-organisasi">
                    ...
                    <script>
                      Swal.fire({
                        ...
                        if (result.isConfirmed) {
                          window.location.href = '/admin/sekolah/struktur-organisasi';
                        }
                      });
                    </script>
                <?php else: ?>
            ...
            <div class="row align-items-center box-edit">
                <div class="col-12">
                    <form class="row justify-content-center"
                          action="/admin/sekolah/struktur-organisasi/edit" method="post"
                          enctype="multipart/form-data">
                        <h4 class="text-center pb-3">Edit Data Stuktur Organisasi</h4>
                        <div class="" id="drop-zone">
                            <div class="image-wrapper">
                                <img id="preview-image" src="/images/upload/struktur-organisasi/<?= $strukturOrganisasi->getStrukturOrganisasi() ?>" alt="Struktur Organisasi">
                            </div>
