        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-5 col-lg-12">
                    <h4 class="secondary-color">Berita</h4>
            ...
            <div class="row align-items-center box-edit">
                <div class="col-12">
                    <h4 class="text-center pb-3">Daftar Berita</h4>
                    <div>
                ...
                <div class="table-responsive">
                    <table class="table berita-table">
                        ...
                        <tbody>
                        <?php foreach ($model['beritaList'] as $index => $berita) : ?>
                            <tr>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <h5 class="modal-title mb-5 mt-4 text-center" id="editBeritaLabel">Edit Data Berita</h5>
                                            <form method="POST"
                    ...
                    <nav aria-label="Halaman" class="d-flex justify-content-center">
                        <ul class="pagination">
                            ...
                            <?php else: ?>
                                <li class="page-item">
                                    <a class="page-link" href="/admin/berita?page=<?= $i ?>"><?= $i ?></a>
                                </li>
                            <?php endif; ?>
                            <?php endfor; ?>
...
<div class="modal fade" id="tambahBeritaModal" tabindex="-1" aria-labelledby="tambahBeritaModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h5 class="modal-title mb-5 mt-4 text-center" id="tambahBeritaModalLabel">Tambah Berita</h5>
