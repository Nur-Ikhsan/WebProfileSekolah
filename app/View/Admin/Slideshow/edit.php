                    ...
                    <form class="row justify-content-center"
                        ...
                        <div class="" id="drop-zone">
                            <div class="image-wrapper">
                                ...
                                <button id="close-button" class="button" style="display: none;"><span class="close-icon">×</span></button>
                            </div>
                        ...
                        <div class="pos-zone row no-gutters">
                            <div class="col-12 p-0">
                                <button type="submit" id="button-simpan" class="button-admin">Simpan</button>
                            </div>
                        </div>
