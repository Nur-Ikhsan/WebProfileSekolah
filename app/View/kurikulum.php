        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-12">
                    ...
                    <h2 class="text-white">Kurikulum</h2>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>Prakarya dan / atau Informatika*)</td>
                        <td>2</td>
                        <td>2</td>
                        <td>2</td>
                    </tr>
