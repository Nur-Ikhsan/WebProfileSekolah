            ...
            <div class="row g-3 my-2">
                <?php foreach ($fasilitasList as $fasilitas): ?>
                    <div class="col-12 col-sm-6  col-md-4 ">
                        <div class="hover-zoom">
                            <div class="shadow-sm position-relative aspect-ratio-container">
                                ...
                                <img src="/images/upload/fasilitas/<?= $fasilitas->getFoto() ?>"
                                     class="img-fluid rounded aspect-ratio-img"
                                     alt="Image Alt Text" data-bs-toggle="modal"
                                     data-bs-target="#imageModal<?= $fasilitas->getId() ?>">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="imageModal<?= $fasilitas->getId() ?>" tabindex="-1"
